...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference('Plant.count') do
      post plants_url, params: { plant: { description: @plant.description, name: @plant.name } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { description: @plant.description, name: @plant.name } }
